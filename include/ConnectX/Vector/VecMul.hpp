#ifndef _CONNECT_X_VECTOR_VECSUM_HPP_
#define _CONNECT_X_VECTOR_VECSUM_HPP_
...
auto operator*(ConnectX::VectorExpression::VecEx<U> const& lhs, ConnectX::VectorExpression::VecEx<V> const& rhs) {
  return ConnectX::VectorExpression::VecMul<U,V>(lhs, rhs);
}
...
#endif // #ifndef _CONNECT_X_VECTOR_VECSUM_HPP_