#ifndef _CONNECT_X_VECTOR_VECLESS_HPP_
#define _CONNECT_X_VECTOR_VECLESS_HPP_
...
auto operator<(ConnectX::VectorExpression::VecEx<U> const& lhs, ConnectX::VectorExpression::VecEx<V> const& rhs) {
  return ConnectX::VectorExpression::VecLess<U,V>(lhs, rhs);
}
